<template lang="pug">
  div(class="panel-object-adjust")
    div(class="panel-object-adjust__options mb-25")
    ...
    div(class="panel-object-adjust__settings")
      mobile-slider(v-if="isLine && currMode === 0" :title="`${$t('NN0681')}`"
        :name="`${$t('NN0681')}`"
        :value="0"
        :min="0"
        :max="0"
        @update="null")
      div(v-if="isLine && currMode === 1" class="panel-object-adjust__line-dash")
      ...
      div(v-if="isLine && currMode === 2" class="panel-object-adjust__markers")
          template(v-for="markerslot in makeSlots")
            div(v-for="(option,index) in options"
                class="panel-object-adjust__option bg-gray-5")
      ...
      div(v-if="isLine && currMode === 3" class="panel-object-adjust__markers")
          template(v-for="markerslot in makeSlots")
            div(v-for="(option,index) in options"
                class="panel-object-adjust__option bg-gray-5")
              marker-icon(iconWidth="18px" iconColor="#474A57" iconHeight="12px"
...
export default Vue.extend({
  ...
  data() {
    return {
      currMode: -1,
      options: ['line-width', 'line-dash', 'start-marker', 'end-marker'],
