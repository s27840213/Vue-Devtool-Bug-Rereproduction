    ...
    div(class="page relative")
      ...
      div(class="page-control")
        nu-controller(
          ...
          :key="`controller-${(config.id === undefined) ? 0 : config.id}`"
          :layerIndex="0"
          :pageIndex="0"
          :config="config"
          :snapUtils="snapUtils")
    panel-fonts(v-if="isOpenFontPanel" class="mobile-panel-fonts" @closeFontsPanel="closeFontsPanel")
    div(v-else class="text-setting" ref='body'
        ...
        div(class="text-setting__color"
          ...
          div(class="color-slip record-selection"
            ...
            color-picker(v-if="openColorPicker"
              ...
              :currentColor="isValidHexColor(props.color) ? props.color : '#000000'"
