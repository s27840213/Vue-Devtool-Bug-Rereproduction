...
class MagnifyUtils {
  ...
  private render(): void {
    this.clear()
    // this.context.save()
    this.magnifyContext.drawImage(this.contentCanvas, 0, 0, this.magnifyCanvas.width, this.magnifyCanvas.height)
    ...
    this.magnifyContext.arc(this.pos.x, this.pos.y, this.MAGNIFY_SIZE, 0, Math.PI * 2, true)
