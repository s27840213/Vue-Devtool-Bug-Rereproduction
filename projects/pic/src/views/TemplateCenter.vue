...
div(ref="body"
  ...
  div(class="template-center__search-container")
    ...
    search-bar(ref="searchbar"
              ...
              @update="handleUpdate"
              @search="handleSearch")
    img(class="color-block vector-purple1" :src="require('@img/svg/color-block/vector_purple1.svg')")
    img(class="color-block oval-lightblue1 non-mobile-show" :src="require('@img/svg/color-block/oval_lightblue1.svg')")
    img(class="color-block oval-orange2 non-mobile-show" :src="require('@img/svg/color-block/oval_orange2.svg')")
  div(ref="mobileSearch" class="template-center__mobile-search__wrapper non-tab-show"
    ...
    div(class="template-center__mobile-search")
      ...
      transition(name="slide-up")
        img(v-if="!mobileSnapToTop" class="color-block oval-lightblue1" :src="require('@img/svg/color-block/oval_lightblue1.svg')")
      transition(name="slide-up")
        img(v-if="!mobileSnapToTop" class="color-block oval-orange2" :src="require('@img/svg/color-block/oval_orange2.svg')")
