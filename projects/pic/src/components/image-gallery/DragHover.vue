...
export default defineComponent({
  ...
  props: {
    text: {
      type: Object as PropType<Record<'hintText' | 'elementType' | 'fileTypes', string>>,
      default: () => ({
