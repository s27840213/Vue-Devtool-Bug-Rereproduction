...
class FrameUtils {
    ...
    if (idx !== -1) {
      ...
      LayerUtils.addLayers(LayerUtils.pageIndex, [layerFactary.newImage({
        ...
        styles: {
          ...
          horizontalFlip: clip.styles.horizontalFlip !== currLayer.styles.horizontalFlip,
          verticalFlip: clip.styles.verticalFlip !== currLayer.styles.verticalFlip,
  ...
  updateFrameClipSrc(pageIndex: number, primaryLayerIndex: number, subLayerIndex: number, srcObj: SrcObj, prePrimaryLayerIndex = -1) {
